...
void SetVT(void){
// write this function
	if((GPIO_PORTF_DATA_R&0x08) == 0x08) GPIO_PORTF_DATA_R = 0x0A;
...
void ClearVT(void){
// write this function
	if((GPIO_PORTF_DATA_R&0x0A) == 0x0A) GPIO_PORTF_DATA_R = 0x08;
...
void SetReady(void){
	// write this function
	if((GPIO_PORTF_DATA_R&0x02) == 0x02) GPIO_PORTF_DATA_R = 0x0A;
...
void ClearReady(void){
// write this function
	if((GPIO_PORTF_DATA_R&0x0A) == 0x0A) GPIO_PORTF_DATA_R = 0x02;
	else GPIO_PORTF_DATA_R = 0x00;
}
